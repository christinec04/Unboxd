...
def scrape_ratings(
        username: str, print_status: bool = False
        ) -> tuple[list[tuple[str, int, float | None]], tuple[str, str, str]]:
    ...
    return (data, ("original_title", "release_year", "user_rating"))
...
if __name__ == "__main__":
    ...
    if "ratings" in sys.argv:
        data, columns = scrape_ratings(username, print_status=True)
